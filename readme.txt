...
amoForm is a plugin that allows you to build and manage forms for your website.
Building a fully functional contact form takes only a few minutes and you don't have to write one bit of PHP, CSS, or HTML! amoForm plugin enable you to give full support to your customers.
...
* Change the name on the menu to anything you would like
* Insert your forms on a page, post, or widget using a shortcode [amoforms id="x"]
